      ...
      <div className="container skew-rev" >
        <div className="row align-items-center cliprow flex-lg-row-reverse " >
          <div className="col-lg-6  rightContent ps-lg-5" >
            ...
            <div className="row signupContent align-items-center" >
              ...
              <div className="col-sm-6" >
                <div className="openMap mb-5 mb-sm-0">
                  <a href="#booknow" className="btn bg-transparent border-0" >OPEN MAP &nbsp; <svg width="31" height="22" viewBox="0 0 31 22" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <Button icon={true} tag="a" href="#booknow" text={"Signup Today!"} 
            cls="btn btn-white mt-xl-4 mb-4" />
          </div>
